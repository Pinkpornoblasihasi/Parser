...
# Copyright (C) 2014-2015 Mira Wolters, Friederike Buch, Marten Stelling, Daniele Panizza
...
class Parser (object):
    ...
    '''
#    splitwords = " ".split(object) 
    ## reverse sentence for bottom-up analysis
#   reversedlist = [] 
#   for i in reversed(object)
#       reversedlist.append("i")
#   for i,j in reversedlist
